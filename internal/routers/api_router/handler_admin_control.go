...
func (h *AdminControlHandler) Upgrade(c *gin.Context) {
	...
	// This self-maintained fork publishes upgrade archives on GitHub only.
	downloadURL := fmt.Sprintf("https://github.com/ZC-eto/fast-note-sync-service/releases/download/%s/%s", versionRaw, fileName)
